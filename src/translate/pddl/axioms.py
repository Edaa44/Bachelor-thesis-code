...
class NumericAxiom:
    ...
    def get_head(self):
        return f_expression.PrimitiveNumericExpression(
            self.name, self.parameters, self.ntype
        )
    ...
    def instantiate(
        ...
        effect = f_expression.PrimitiveNumericExpression(
            self.name, arg_list, self.ntype
        )
