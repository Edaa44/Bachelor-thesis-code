...
def parse_args():
    ...
    argparser.add_argument("domain", nargs="?", default=None, help="path to domain pddl file")
    argparser.add_argument("task", nargs="?", default=None, help="path to task pddl file")
